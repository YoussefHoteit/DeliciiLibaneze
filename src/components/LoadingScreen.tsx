...
const LoadingScreen = () => {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      exit="exit"
      className="fixed inset-0 z-[9999] bg-[#F5EFE6] flex flex-col items-center justify-center"
    >
      <div className="relative max-w-[300px] md:max-w-[400px] w-full px-6 flex flex-col items-center -translate-y-8 md:translate-y-0">
        {/* Step 2: Logo fades in with blend mode to remove white background */}
        <motion.img 
          ...
          className="w-full h-auto mb-4 md:mb-8 mix-blend-multiply"
        />
