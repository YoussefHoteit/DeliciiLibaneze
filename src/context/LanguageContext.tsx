...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'menu.sub.savory': 'Savory Delights',
  ...
  ro: {
    ...
    'menu.sub.savory': 'Delicii Sărate',
    ...
    'feature.3.title': 'Premium',
    'feature.3.desc': 'De la cafeaua noastră de specialitate la sucurile noastre proaspete, calitatea este în centrul a tot ceea ce avem.',
