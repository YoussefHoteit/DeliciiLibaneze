...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'menu.icecream.info': 'Served in a crispy cone or cup. Crafted with 100% natural ingredients, fresh goat milk, and traditional orchid roots. Discover our weekly handpicked selection of artisanal flavors.',
    'menu.sub.juices': 'Fresh Juices & Traditional Drinks',
    'menu.sub.coffee': 'Espresso & Coffee',
    'menu.sub.tea': 'Artisan Tea & Warm Specialties',
  ...
  ro: {
    ...
    'menu.icecream.info': 'Servită în cornet crocant sau pahar. Preparată cu ingrediente 100% naturale, lapte proaspăt de capră și rădăcini tradiționale de orhidee. Descoperă selecția noastră săptămânală de arome artizanale.',
    'menu.sub.juices': 'Sucuri Proaspete și Băuturi Tradiționale',
    'menu.sub.coffee': 'Espresso & Cafea',
    'menu.sub.tea': 'Ceai Artizanal și Specialități Calde',
